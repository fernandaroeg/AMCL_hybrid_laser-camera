...
class detector:
    ...
    def callback(self, data):
        try:
            ...
            found_rectangle, rectangles_img, rectangle_cropped, rectangle_crop_points = self.findRectangles(contours, canvas)
    ...
    def findRectangles(self, contours, original_img):
    ...
    def sortCorners(self, img, corners, markerID):
        ...
        text = str("MarkerID:" + str(markerID))
