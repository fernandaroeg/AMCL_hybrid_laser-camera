...
class detector:
    def __init__(self):
        ...
        #2. Parameters SETUP
        self.markers_path     = rospy.get_param('/detectorSIFT2/markers_path')
        self.export_path = rospy.get_param('/detectorSIFT2/export_path')
        self.thresh_bin   = rospy.get_param('/detectorSIFT2/thresh_bin')
        self.corner_colors  = ((255, 0, 0), (0, 255, 0), (0, 0, 255), (0, 255, 255)) #BGR coners
        self.export_img_det = True
        
        lst = os.listdir(self.markers_path)
        ...
        for i in range(0, self.numMarkers):
            path = str(self.markers_path + "marker" + str(i) +".bmp") 
